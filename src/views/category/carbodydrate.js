async function loadProducts() {
  try {
    const response = await fetch('../data/carbohydrate.json');
    const products = await response.json();

    const container = document.querySelector('.carbohydrateContainer');
    ...
    products.forEach((product) => {
      ...
      productDiv.className = 'carbohydrateContainer';
